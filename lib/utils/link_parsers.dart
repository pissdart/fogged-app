...
import 'package:fogged/utils/validators.dart';
...
abstract class LinkParser {
  static String generateSubShareLink(String url, [String? name]) {
    ...
    // return 'fogged://import/$modifiedUri';
    return '$modifiedUri';
  }

  // protocols schemas
  static const protocols = ['fogged', 'v2ray', 'v2rayn', 'v2rayng', 'clash', 'clashmeta', 'sing-box'];
