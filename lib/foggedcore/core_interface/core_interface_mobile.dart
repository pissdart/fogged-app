...
import 'package:fogged/core/utils/laststeam.dart';
...
final _logger = Loggy('FFIFoggedCoreService');

class CoreInterfaceMobile extends CoreInterface with InfraLogger {
  static const channelPrefix = "com.fogged.app";
  ...
  Future<String> setup(Directories directories, bool debug, int mode) async {
    ...
    // await start("/sdcard/Android/data/app.fogged.com/files/configs/cdc633e9-8cfc-4a67-948d-009f779a5c91.json", "fogged");
    return "";
  }
