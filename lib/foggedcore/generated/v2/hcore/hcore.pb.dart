...
class ChangeFoggedSettingsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ChangeFoggedSettingsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'hcore'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'foggedSettingsJson')
    ..hasRequiredFields = false
  ;

  ChangeFoggedSettingsRequest._() : super();
  factory ChangeFoggedSettingsRequest({
    $core.String? foggedSettingsJson,
  }) {
    final _result = create();
    if (foggedSettingsJson != null) {
      _result.foggedSettingsJson = foggedSettingsJson;
    }
    return _result;
  }
  factory ChangeFoggedSettingsRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ChangeFoggedSettingsRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ChangeFoggedSettingsRequest clone() => ChangeFoggedSettingsRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ChangeFoggedSettingsRequest copyWith(void Function(ChangeFoggedSettingsRequest) updates) => super.copyWith((message) => updates(message as ChangeFoggedSettingsRequest)) as ChangeFoggedSettingsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ChangeFoggedSettingsRequest create() => ChangeFoggedSettingsRequest._();
  ChangeFoggedSettingsRequest createEmptyInstance() => create();
  static $pb.PbList<ChangeFoggedSettingsRequest> createRepeated() => $pb.PbList<ChangeFoggedSettingsRequest>();
  @$core.pragma('dart2js:noInline')
  static ChangeFoggedSettingsRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ChangeFoggedSettingsRequest>(create);
  static ChangeFoggedSettingsRequest? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get foggedSettingsJson => $_getSZ(0);
  @$pb.TagNumber(1)
  set foggedSettingsJson($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasFoggedSettingsJson() => $_has(0);
  @$pb.TagNumber(1)
  void clearFoggedSettingsJson() => clearField(1);
}
