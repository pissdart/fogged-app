...
class CoreClient extends $grpc.Client {
  ...
  static final _$changeFoggedSettings =
      $grpc.ClientMethod<$0.ChangeFoggedSettingsRequest, $0.CoreInfoResponse>(
          '/hcore.Core/ChangeFoggedSettings',
          ($0.ChangeFoggedSettingsRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.CoreInfoResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.CoreInfoResponse> changeFoggedSettings(
      $0.ChangeFoggedSettingsRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$changeFoggedSettings, request, options: options);
  }
...
abstract class CoreServiceBase extends $grpc.Service {
  ...
  CoreServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.ChangeFoggedSettingsRequest,
            $0.CoreInfoResponse>(
        'ChangeFoggedSettings',
        changeFoggedSettings_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.ChangeFoggedSettingsRequest.fromBuffer(value),
        ($0.CoreInfoResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.StartRequest, $0.CoreInfoResponse>(
        'StartService',
        startService_Pre,
  ...
  $async.Future<$0.CoreInfoResponse> changeFoggedSettings_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.ChangeFoggedSettingsRequest> request) async {
    return changeFoggedSettings(call, await request);
  }
  ...
  $async.Future<$0.CoreInfoResponse> changeFoggedSettings(
      $grpc.ServiceCall call, $0.ChangeFoggedSettingsRequest request);
