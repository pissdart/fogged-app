...
import 'package:fogged/core/analytics/analytics_controller.dart';
import 'package:fogged/core/app_info/app_info_provider.dart';
...
import 'package:fogged/core/logger/logger.dart';
import 'package:fogged/core/logger/logger_controller.dart';
import 'package:fogged/core/model/environment.dart';
import 'package:fogged/core/preferences/general_preferences.dart';
import 'package:fogged/core/preferences/preferences_migration.dart';
import 'package:fogged/core/preferences/preferences_provider.dart';
import 'package:fogged/features/app/widget/app.dart';
import 'package:fogged/features/auto_start/notifier/auto_start_notifier.dart';

import 'package:fogged/features/log/data/log_data_providers.dart';
...
import 'package:fogged/features/window/notifier/window_notifier.dart';
import 'package:fogged/foggedcore/fogged_core_service_provider.dart';
import 'package:fogged/riverpod_observer.dart';
...
Future<void> lazyBootstrap(WidgetsBinding widgetsBinding, Environment env) async {
  ...
  await _init("fogged-core", () => container.read(foggedCoreServiceProvider).init());
