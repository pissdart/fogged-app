...
@$core.Deprecated('Use changeFoggedSettingsRequestDescriptor instead')
const ChangeFoggedSettingsRequest$json = const {
  '1': 'ChangeFoggedSettingsRequest',
  '2': const [
    const {'1': 'fogged_settings_json', '3': 1, '4': 1, '5': 9, '10': 'foggedSettingsJson'},
  ],
};

/// Descriptor for `ChangeFoggedSettingsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List changeFoggedSettingsRequestDescriptor = $convert.base64Decode('ChxDaGFuZ2VIaWRkaWZ5U2V0dGluZ3NSZXF1ZXN0EjIKFWhpZGRpZnlfc2V0dGluZ3NfanNvbhgBIAEoCVITaGlkZGlmeVNldHRpbmdzSnNvbg==');
