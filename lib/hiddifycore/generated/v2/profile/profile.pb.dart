...
import '../foggedoptions/fogged_options.pb.dart' as $8;
...
class ProfileEntity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProfileEntity', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'profile'), createEmptyInstance: create)
    ...
    ..aOM<$8.FoggedOptions>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'overrideFoggedOptions', subBuilder: $8.FoggedOptions.create)
  ...
  factory ProfileEntity({
    ...
    $8.FoggedOptions? overrideFoggedOptions,
  }) {
    ...
    if (overrideFoggedOptions != null) {
      _result.overrideFoggedOptions = overrideFoggedOptions;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(8)
  $8.FoggedOptions get overrideFoggedOptions => $_getN(6);
  @$pb.TagNumber(8)
  set overrideFoggedOptions($8.FoggedOptions v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasOverrideFoggedOptions() => $_has(6);
  @$pb.TagNumber(8)
  void clearOverrideFoggedOptions() => clearField(8);
  @$pb.TagNumber(8)
  $8.FoggedOptions ensureOverrideFoggedOptions() => $_ensure(6);
}
