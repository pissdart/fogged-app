...
import 'package:fogged/core/localization/locale_extensions.dart';
import 'package:fogged/core/localization/locale_preferences.dart';
import 'package:fogged/core/localization/translations.dart';
import 'package:fogged/core/model/constants.dart';
...
import 'package:fogged/core/theme/app_theme.dart';
import 'package:fogged/core/theme/theme_preferences.dart';
import 'package:fogged/features/app_update/notifier/app_update_notifier.dart';
import 'package:fogged/features/connection/widget/connection_wrapper.dart';
import 'package:fogged/features/per_app_proxy/overview/per_app_proxy_service_notifier.dart';
import 'package:fogged/features/profile/notifier/profiles_update_notifier.dart';
import 'package:fogged/features/shortcut/shortcut_wrapper.dart';
import 'package:fogged/features/system_tray/notifier/system_tray_notifier.dart';
import 'package:fogged/features/window/widget/window_wrapper.dart';
...
class App extends HookConsumerWidget with WidgetsBindingObserver, PresLogger {
  ...
  void onPause(WidgetRef ref) {
    ...
    ref.read(foggedCoreServiceProvider).closeFront();
  }

  void onResume(WidgetRef ref) {
    // if (PlatformUtils.isDesktop) return;
    ref.read(foggedCoreServiceProvider).init();
