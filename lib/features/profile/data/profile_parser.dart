...
import 'package:fogged/singbox/model/singbox_proxy_type.dart';
    ...
    final rs = await _httpClient
        .download(
          ...
          userAgent: _ref.read(ConfigOptions.useXrayCoreWhenPossible)
              ? _httpClient.userAgent.replaceAll("FoggedNext", "FoggedNextX")
              : null,
        )
        .catchError((err) {
        ...
        try {
          ...
          await httpClient.download(
            ...
            userAgent: ref.read(ConfigOptions.useXrayCoreWhenPossible)
                ? httpClient.userAgent.replaceAll('FoggedNext', 'FoggedNextX')
                : null,
          );
