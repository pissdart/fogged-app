...
import 'package:fogged/core/db/db.dart';

import 'package:fogged/core/utils/exception_handler.dart';
import 'package:fogged/features/profile/data/profile_data_mapper.dart';
import 'package:fogged/features/profile/data/profile_data_source.dart';
import 'package:fogged/features/profile/data/profile_parser.dart';
...
import 'package:fogged/features/profile/model/profile_sort_enum.dart';
...
class ProfileRepositoryImpl with ExceptionHandler, InfraLogger implements ProfileRepository {
  ProfileRepositoryImpl({
    ...
    required FoggedCoreService singbox,
  ...
  final FoggedCoreService _singbox;
