...
pub struct ClientConfig {
    ...
    /// Reality client config — if set, encrypt auth data into the SessionID
    /// for anti-DPI stealth (connection looks like normal HTTPS to the SNI domain).
    pub reality_client_config: Option<Arc<crate::reality::RealityClientConfig>>,
}
...
impl Clone for ClientConfig {
    fn clone(&self) -> Self {
        Self {
            ...
            reality_client_config: self.reality_client_config.clone(),
        }
    }
}
